                ...
                for (i in questions) {
                    if (questions.hasOwnProperty(i)) {
                        ...
                        if (plugin.config.backButtonText && plugin.config.backButtonText !== '') {
                            questionHTML.append('<a href="#" class="butfton ' + backToQuestionClass + '"><button type="button" class="btn btn-info btn-lg">' + plugin.config.backButtonText + '</button></a>');
                        }

                        // If we're not showing responses per question, show next question button and make it check the answer too
                        if (!plugin.config.perQuestionResponseMessaging) {
                            questionHTML.append('<a href="#" class="butfton ' + nextQuestionClass + ' ' + checkAnswerClass + '"><button type="button" class="btn btn-info btn-lg">' + plugin.config.nextQuestionText + '</button></a>');
                        } else {
                            questionHTML.append('<a href="#" class="butfton ' + nextQuestionClass + '"><button type="button" class="btn btn-info btn-lg">' + plugin.config.nextQuestionText + '</button></a>');
                            questionHTML.append('<a href="#" class="butfton ' + checkAnswerClass + '"><button type="button" class="btn btn-info btn-lg">' + plugin.config.checkAnswerText + '</button></a>');
                        }
